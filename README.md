...
- 公開サイト: https://hjosugi.github.io/cloud-hub/（ブラウザー言語に応じて日本語 / Englishを選択）
- 日本語: https://hjosugi.github.io/cloud-hub/cloud-hub.html
...
1. [4クラウドの思想](docs/guides/cloud-philosophies.ja.md)
2. [マルチクラウド設計判断](docs/guides/multicloud-design.ja.md)
3. [運用モデル比較](docs/guides/operations-comparison.ja.md)
4. [リリースの読み方](docs/guides/release-intelligence.ja.md)
5. [用途検索と費用比較](docs/guides/service-and-cost-comparison.ja.md)
...
├── site/index.html                 言語自動選択エントリーポイント
├── site/cloud-hub.html             日本語版GitHub Pages本体
├── site/cloud-hub.en.html          English版GitHub Pages本体
...
基準日: 2026-07-23。仕様とSLAの最終判断は各cloudの公式documentationを参照してください。
